...
//NewxeroServerServer returns a xeroServerServer implementation with core business logic
func NewxeroServerServer(Store pb.AccoutingEmployeeLinkStore) pb.XeroServerServer {
	return &accountyServer{store: Store}
}
...
func ConnectToXeroAPI(urlxero, payloadxerostr string) ([]byte, error) {

	payload := strings.NewReader(payloadxerostr)

	req, _ := http.NewRequest("POST", urlxero, payload)

	//req.Header.Add("Authorization", ",OAuth oauth_consumer_key="54BT1LQ29XWN7N7PMCLOZ5KBE0WTFY",oauth_token="OVNZ5AUGBICYOKCFCFD7YVBYXBMEHA",oauth_signature_method="HMAC-SHA1",oauth_timestamp="1561381067",oauth_nonce="aJk38fmD4xW",oauth_version="1.0",oauth_signature="NHhp4nT0FjjvmKuC6SwRrpDqQmQ%3D"")
	req.Header.Add("accept", "application/json")
	req.Header.Add("cac	he-control", "no-cache")
	req.Header.Add("Postman-Token", "9649b00f-c1f2-461a-a723-deab81488a3a")
...
//***********************************************************************************************************************************************************************************************************************
//###############################################core account modification RPCs(Xero) #########################################################################################################################################
//***********************************************************************************************************************************************************************************************************************
//Invoice API for payment##########################################################################################################################################################################################
func InvoicePayment(CompanyID, AppointyId, Amount, CustomerID string, Store pb.AccoutingEmployeeLinkStore) (string, error) {
